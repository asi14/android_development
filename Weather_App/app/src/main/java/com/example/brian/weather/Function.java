...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "1e9c32c0fc914b4886bf6cf637da6770";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                    ...
                    String temperature = String.format("%.2f", main.getDouble("temp"))+ "°C";/*don't forget the +C!*/
                    String tempNum=String.format("%.2f", main.getDouble("temp"));
                    ...
                    delegate.processFinish(city, description, temperature, humidity, pressure, updatedOn,
                            iconText, ""+ (json.getJSONObject("sys").getLong("sunrise") * 1000),tempNum);
